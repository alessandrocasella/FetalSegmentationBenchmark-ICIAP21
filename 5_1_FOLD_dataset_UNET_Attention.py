...
class myUnet(object):
    ...
    def get_unet(self, training=True, data_format='channels_last'):
        ...
        ag1 = AttnGatingBlock(c4, c5, 512)
        ag1 = Conv2D(256, (3, 3), activation='relu', kernel_initializer='he_normal', padding='same')(ag1)
        ag1 = BatchNormalization()(ag1)
        ag1 = Dropout(0.2)(ag1)
        ag1 = Conv2D(256, (3, 3), activation='relu', kernel_initializer='he_normal', padding='same')(ag1)
        ag1 = BatchNormalization()(ag1)

        u6 = UpSampling2D((2, 2), interpolation='nearest')(c5)
        u6 = concatenate([u6, ag1])
        ...
        ag2 = AttnGatingBlock(c3, c6, 256)
        ag2 = Conv2D(128, (3, 3), activation='relu', kernel_initializer='he_normal', padding='same')(ag2)
        ag2 = BatchNormalization()(ag2)
        ag2 = Dropout(0.2)(ag2)
        ag2 = Conv2D(128, (3, 3), activation='relu', kernel_initializer='he_normal', padding='same')(ag2)
        ag2 = BatchNormalization()(ag2)

        u7 = UpSampling2D((2, 2), interpolation='nearest')(c6)
        u7 = concatenate([u7, ag2])
        ...
        ag3 = AttnGatingBlock(c2, c7, 128)
        ag3 = Conv2D(63, (3, 3), activation='relu', kernel_initializer='he_normal', padding='same')(ag3)
        ag3 = BatchNormalization()(ag3)
        ag3 = Dropout(0.2)(ag3)
        ag3 = Conv2D(63, (3, 3), activation='relu', kernel_initializer='he_normal', padding='same')(ag3)
        ag3 = BatchNormalization()(ag3)

        u8 = UpSampling2D((2, 2), interpolation='nearest')(c7)
        u8 = concatenate([u8, ag3])
        ...
        ag4 = AttnGatingBlock(c1, c8, 64)
        ag4 = Conv2D(32, (3, 3), activation='relu', kernel_initializer='he_normal', padding='same')(ag4)
        ag4 = BatchNormalization()(ag4)
        ag4 = Dropout(0.2)(ag4)
        ag4 = Conv2D(32, (3, 3), activation='relu', kernel_initializer='he_normal', padding='same')(ag4)
        ag4 = BatchNormalization()(ag4)

        u9 = UpSampling2D((2, 2), interpolation='nearest')(c8)
        u9 = concatenate([u9, ag4])
