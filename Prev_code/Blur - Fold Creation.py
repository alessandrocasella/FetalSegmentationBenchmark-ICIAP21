...
Polimi_dataset = os.path.join(os.getcwd(), 'BLUR - CONTRAST -  NI -  REDUCED FOV - POLIMI DATASET')
...
directory = 'K FOLD - BLUR - CONTRAST - NI - REDUCED FOV - POLIMI DATASET'
...
n_patient = len(Image_numpy_subfolders)
